# Ramapo College Transportation Guide

*Last Updated: January 29, 2026*

Information on getting to and around campus.
...
1. Take Exit 66 (Route 17 North)
2. Follow Route 17 North for about 3 miles
3. Take Ramapo Valley Road exit
4. Turn right onto Ramapo Valley Road
5. Campus entrance on the left

#### From Garden State Parkway (North or South)
1. Take Exit 163 (Route 17 North)
2. Follow Route 17 North
3. Take Ramapo Valley Road exit
4. Turn right onto Ramapo Valley Road
5. Campus entrance on the left

#### From Route 287 (Alternate)
1. Take Route 202 North exit
2. Follow Route 202 North
3. Campus on the right at Ramapo Valley Road intersection
...
#### Route 196
- **Service:** Connects to Port Authority NYC
- **Stop:** Ramapo College main entrance
- **Schedule:** Check njtransit.com for current times

#### Route 164
- **Service:** Local Bergen County service
- **Connections:** Connects to other NJ Transit routes

### Train Connections
**Nearest Train Stations:**
- **Mahwah Station** - NJ Transit Main Line (~4 miles)
- **Ramsey Route 17 Station** - NJ Transit (~5 miles)

> **Note:** From train stations, you'll need a ride-share, taxi, or local bus to campus
...
### Ride-Share Services
- **Uber** - Available in Mahwah area
- **Lyft** - Available in Mahwah area

### Local Taxi Services
Contact Public Safety at 201-684-7432 for recommended local taxi companies

---

## 🅿️ **Visitor Parking**

### Getting a Visitor Permit
1. Stop at **Public Safety Booth** at main entrance
2. Provide ID and reason for visit
3. Receive temporary parking permit
4. Display on dashboard

### Loading/Unloading
- **20-minute passes** available at Main Entrance booth
- Use for quick drop-offs and pick-ups
...
- Follow pedestrian pathways
- Wear helmet for safety

### Walking Paths
- Well-lit pathways throughout campus
- SafeWalk program available for evening escorts
- Call Public Safety: 201-684-7432
...
- **Options:** Rental car, Uber/Lyft, NJ Transit train + connection

### John F. Kennedy International (JFK)
- **Distance:** ~40 miles
- **Travel Time:** 60-90 minutes
- **Options:** Rental car, Uber/Lyft
...
| Service | Contact |
|---------|---------|
| **Campus Shuttle Info** | 201-684-7500 |
| **Public Safety** | 201-684-7432 |
| **NJ Transit** | njtransit.com or call 973-275-5555 |
| **Parking Office** | parking@ramapo.edu or 201-684-7432 |

---

## 💡 **Tips for First-Time Visitors**

1. **Use GPS:** Input "505 Ramapo Valley Road, Mahwah, NJ 07430"
2. **Plan Ahead:** Traffic on Route 17 can be heavy during rush hour
3. **Get a Permit:** Stop at Public Safety booth before parking
4. **Ask for Directions:** Public Safety staff are very helpful
5. **Campus Map:** Available at entrance and online at ramapo.edu/map
...
### Campus Alerts
- Check **ramapo.edu** for closure announcements
- Sign up for emergency alerts through student portal
- Follow Ramapo College social media

### Emergency Contact
- **Campus Security:** 201-684-6666
